...
// тут все правильно есть момент с тем что ты передаешь аргумент как строку а в массиве числа, нужно продумать такой вариант 
// что человек хочет удалить именно числа а не строку 3, или по типу сравнивать и не удалять в таком случае
